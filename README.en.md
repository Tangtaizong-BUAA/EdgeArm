...
**[Read the illustrated technical report (Chinese)](README.md)** — final training
stack, spatial memory, synthetic data, online residual RL, experiment history,
and two [evaluation-only wrist replay videos](docs/media/README.md).
...
included. Two independently evaluated wrist replays are published separately as
report illustrations. The tiny test fixture is synthetic and is never counted as robot data.
